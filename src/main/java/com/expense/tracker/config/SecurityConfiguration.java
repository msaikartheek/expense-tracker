    ...
    public WebMvcConfigurer corsConfigurer() {
        ...
        return new WebMvcConfigurer() {
            ...
            public void addCorsMappings(CorsRegistry registry) {
                registry.addMapping("/**")
                        .allowedOrigins("http://localhost:63342","https://www.interiorsbyagi.in","http://localhost:4200","https://expense-tracker-1710.web.app")  // Add the origins you want to allow
